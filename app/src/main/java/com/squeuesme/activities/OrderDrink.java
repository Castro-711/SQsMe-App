...
public class OrderDrink extends AppCompatActivity {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_order_drink, menu);
        return true;
    }
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            View rootView = inflater.inflate(
                    R.layout.fragment_order_drink, container, false);

            ImageView drinkImage = rootView.findViewById(R.id.orderDrinkImage);
